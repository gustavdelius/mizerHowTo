...
In this example  we will read in a calibrated model for the North Sea, which consists of 12 interacting species and a backgorund resource. All species are predators and prey since they feed according to size-based rules and they encounter each  other.
...
### Example #2. Maintaining Fisheries Yields in a Changing Environment
