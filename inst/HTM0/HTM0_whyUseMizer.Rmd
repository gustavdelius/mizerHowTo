...
# remove comment, needed to add species
...
## Exercise: Set up your own fishing scenario
...
Now try to edit the above code to create your own fishing scenario.
...
```{r, echo = F}
knitr::kable(new_params@species_params %>% select(species, biomass_observed, R_max, erepro))
```


<!-- ### Example 4: Adding a variable environment -->
