...
# leaving library for developper knitting
library(mizerHowTo) 
...
flextable::regulartable(proj_effortDf_short)
...
```{r}
sim_trawler <- projectToSteady(params, effort = 1, return_sim = TRUE, t_max = 200)
