...
There are many other possible approaches for model calibration and post-hoc exploration. A couple of other approaches we have put together that you may be interested in exploring on your own are:

- tuneParams() is a more comprehensive shiny app to explore, tune and help understand mizer models. 

- HTM3 is a more davanced tutoiral that uses time-series fitting (work in progress but feel free to check it out and let us know what you think)
